...
function Management() {
  ...
  return (
    <>
      <div className="flex relative flex-col lg:flex-row md:order-2 xl:order-1 bg-devel bg-cover px-5 bg-no-repeat items-center justify-between md:gap-10 lg:gap-0 py-32 md:h-[430px] lg:h-[650px]">
