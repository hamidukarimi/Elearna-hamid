...
function CourseFin() {
  ...
  return (
    <>
      <div className="flex relative flex-col lg:flex-row md:order-2 xl:order-1 bg-devel3 bg-cover px-5 bg-no-repeat items-center justify-between md:gap-10 lg:gap-0 py-32 md:h-[430px] lg:h-[650px]">
        <div className="px-5 flex flex-col gap-2 sm:gap-5 justify-center items-start bg-gradient-to-b from-[#0f252ac4] from-55% to-[#ffffff00] to-9 0% ... absolute top-0 left-0 right-0 h-full w-full">
          <p className="font-semibold text-xs sm:text-sm text-white">FINANCE</p>
          ...
          <div className="flex gap-1 mt-2">
            <img src={rate} alt="" />
            <span className="text-sm text-[#a19e9e]">5.00 (1.2K)</span>
          </div>
        </div>
        <div
          // data-aos="fade-up"
