...
import blog1 from "../../../../assets/images/Home1/bl1.jpg";
import { CategoryData6 } from "../../Categories/CategoryData";

function BlogOne() {
  return (
    <>
      <div className="flexrelative flex-col lg:flex-row md:order-2 xl:order-1 bg-blog1 bg-cover px-5 bg-no-repeat items-center justify-between md:gap-10 lg:gap-0 py-32 h-[585px]">
        <div className="flex flex-col gap-5 justify-center items-center px-5 w-full text-white absolute left-0 right-0 top-0 h-full bg-[#00000092]">
          <p className="text-white font-semibold">CAREER NINA LEFFLER</p>
